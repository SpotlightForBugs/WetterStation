...
public class WeatherStation {
    ...
    //data[day][time in hours][data type as number][the actual data] //example: data[6][13][4][360] = 360 degrees of wind direction at 13:00 on day 6
    
  
    
    //the time is incremented by 1 hour for each row of the array 

    // the temperature is in degrees celsius and is a double between -89.2 and 56.7  the data type is 0
    ...
    public void sendDayData(int sendDay) {
        //first check if the day is valid by checking if it is less or equal to the day that is being measured
        if (sendDay <= day) {
