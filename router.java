...
public class router {
    ...
    private double[][][][] receiveData = new double[10000000][24][6][1]; //this is the data that is being sent to the weather hub
    ...
    public void receiveDataFromStation(double[][][][] data, String name, String location) {
        //this function receives data from a weather station and adds it to the history of data that has been sent to the weather hub
    ...
    public void sendAllDataToHub(double[][][][] data, String name, String location) {
        ...
        weatherHub.receiveData(data, name, location);
        //set the data in the transmission history to the data that was sent, overwriting the old data because all the data has been sent
        for (int i = 0; i < 24; i++) {
            for (int j = 0; j < 6; j++) {
