    ...
    public void setupWeatherStation(String pName, String pLocation) {
        ...
        for (int i = 0; i < knownStations; i++) {
            if (knownWeatherStations[i].equals(pName + "-" + pLocation)) {
                ...
                throw new IllegalArgumentException("The name and location of the weather station are already in use");
            }
        ...
        knownWeatherStations[knownStations] = pName + "-" + pLocation; //add the name and location to the list of known weather stations
